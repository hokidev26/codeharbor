...
import messagesEN from "./messages-en.mjs?v=settings-flat-1-codex-browser-login-1-apple-theme-1";
...
import messagesZhCN from "./messages-zh-CN.mjs?v=settings-flat-1-codex-browser-login-1-apple-theme-1";
import messagesZhTW from "./messages-zh-TW.mjs?v=settings-flat-1-codex-browser-login-1-apple-theme-1";
