  ...
  "zh-CN": {
    preferences: {
      ...
      settings: {
        ...
        profileSynced: "个人资料已同步到当前账号。",
        profilePending: "个人资料已保存，正在等待同步。",
        profileOffline: "个人资料已保存在当前账号的离线缓存中。",
  ...
  "zh-TW": {
    preferences: {
      ...
      settings: {
        ...
        profileSynced: "個人資料已同步至目前帳號。",
        profilePending: "個人資料已儲存，正在等待同步。",
        profileOffline: "個人資料已儲存在目前帳號的離線快取中。",
  ...
  en: {
    preferences: {
      ...
      settings: {
        ...
        profileSynced: "Profile preferences synced to this account.",
        profilePending: "Profile preferences are saved and waiting to sync.",
        profileOffline: "Profile preferences are stored in this account's offline cache.",
